			...
			<div className='flex flex-col md:flex-row  text-white py-8 text-[16px] gap-2 md:gap-4  '>
				<div className='w-1/5 lg:w-[20%] text-[16px] md:text-xl  '>
					...
					<ul className='flex flex-col md:gap-2  leading-[18.2px] font-garden_regular text-[14px] md:text-base'>
						<li onClick={() => Push('/')} className='cursor-pointer'>
							Inicio
						</li>
						<li onClick={() => Push('/nosotros')} className='cursor-pointer'>
							Nosotros
						</li>
						<li onClick={() => Push('/servicios')} className='cursor-pointer'>
							Servicios
						</li>
						<li onClick={() => Push('/tienda')} className='cursor-pointer'>
							Tienda
						</li>
						<li onClick={() => Push('/proyectos')} className='cursor-pointer'>
							Proyectos
						</li>
						<li onClick={() => Push('/blogs')} className='cursor-pointer'>
							Blog
						</li>
						<li onClick={() => Push('/contactos')} className='cursor-pointer'>
							Contacto
						</li>
					</ul>
				</div>
				<div className='w-[26.6] lg:w-[27%] text-[16px] md:text-xl  '>
					...
					<ul className='flex flex-col  md:gap-2  leading-[18.2px] font-garden_regular text-[14px] md:text-base'>
						<li onClick={() => Push('/servicios/paisajismo')} className='cursor-pointer'>
							Paisajismo
						</li>
						<li onClick={() => Push('/servicios/jardinesverticales')} className='cursor-pointer'>
							Jardines verticales
						</li>
						<li onClick={() => Push('/servicios/mantenimientodeareasverdes')} className='cursor-pointer'>
							Mantenimiento de áreas verdes
						</li>
						<li onClick={() => Push('/servicios/techosverdes')} className='cursor-pointer'>
							Techos verdes
						</li>
						<li onClick={() => Push('/servicios/sistemaderiegotecnificado')} className='cursor-pointer'>
							Sistemas de riego tecnificado
						</li>
						<li onClick={() => Push('/servicios/impermeabilización')} className='cursor-pointer'>
							Impermeabilización
						</li>
						<li onClick={() => Push('/servicios/vivero')} className='cursor-pointer'>
							Vivero
						</li>
					</ul>
				</div>
				...
				<div className='w-[26.7] lg:w-[26%] flex flex-col justify-between text-[16px] md:text-xl  '>
					<div className=''>
						<div className=' tracking-[1px] capitalize  leading-[23.24px] font-garden_bold  text-garden-option2 my-3 text-[16px] md:text-xl'>
							Proveedor Oficial
						</div>
						<span className='block my-3 font-garden_regular text-[14px] w-4/5 md:w-full   md:text-base'>
							¡Somos proveedores oficiales de CASACOR PERÚ desde hace 03 ediciones!
						</span>
					</div>
