    ...
    <div className='flex flex-col items-center justify-center '>
      ...
      <div className='w-full md:w-[500px] h-auto '>
        ...
        <div
          ...
          className="cursor-pointer w-[325px] h-[210px] mx-auto md:h-[250px] md:w-[400px] mt-8"
        >
          <div
          ...
          >
            ...
            >
              ...
              <div className='w-[40px]'>
                <Image
                  src="/imgs/creditCard/chip-tarjeta.png"
                  alt="chip"
                  width={'100%'}
                  height={'100%'}
                />
            ...
            >
              ...
              <div className='flex mt-14 items-center'>
                ...
                <div className="flex flex-col">
                  <small>CCV</small>
                  {/* <div className="bg-white h-5 md:h-7 text-gray-400 px-2 italic">{"ccv"}</div> */}
                  <div className="bg-white h-5 md:h-7 text-gray-400 px-2 italic">{cvc || "ccv"}</div>
                </div>
              </div>
              <div className='mt-6'>
