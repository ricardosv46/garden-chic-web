          ...
          <form
            ...
            {recojo === 'Delivery' && (
              <div className='flex flex-col gap-5 xl:flex-row '>
                <SelectSearch tittle='Departamento' data={dataDepartamentos} name='depa' value={depa} setStateMutation={setStateMutation} />
                <SelectSearch
                  tittle='Provincia'
                  data={dataProvincias}
                  name='prov'
            ...
            <div>
              ...
              <div className='grid grid-cols-1 gap-5 mt-1 lg:grid-cols-2'>
                ...
                <div className='relative'>
                  <input className='hidden group peer' type='radio' required name='tipoPago' value='Efectivo' id='Efectivo' onChange={onChange} />
