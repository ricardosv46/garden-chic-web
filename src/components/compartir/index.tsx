  ...
  return (
    <div className='flex gap-2'>
      ...
      <div
        onClick={() =>
          window.open(
            `https://www.facebook.com/sharer/sharer.php?u=https://garden-chic-web.vercel.app/blogs/${ruta}/`,
            '_blank'
          )
        }
      ...
      <div
        ...
        onClick={() =>
          window.open(
            `https://twitter.com/intent/tweet?text=https://garden-chic-web.vercel.app/blogs/${ruta}`,
            '_blank'
          )
        }
      >
      ...
      <div
        ...
        onClick={() =>
          window.open(
            ` https://www.linkedin.com/shareArticle?mini=true&url=https://garden-chic-web.vercel.app/blogs/${ruta}/&title=${title} `,
            '_blank'
          )
        }
      >
