	...
	return (
		<>
			<Container>
				...
				<div className='relative '>
					...
					<div className='flex justify-center '>
						<div
							...
							<Image layout='fill' src='/icons/png/iconProyect_circle.png' alt='imagen proyecto' className='rounded-lg' />
						</div>
					</div>
				</div>
				...
				<div className='flex flex-col-reverse xl:flex-row gap-5 pb-10 pt-4 sm:pt-16 justify-center items-start '>
					...
					<div className='flex-1 py-10 lg:p-10 flex flex-col justify-center '>
						<h2 className='text-center text-2xl md:text-3xl lg:text-5xl text-garden-option1 font-garden_bold'>Antes</h2>
						{proyecto?.antes!.map((obj, i) => (
							<p key={i} className='text-justify text-base xl:text-xl text-garden-option3 font-garden_regular pt-4'>
								{obj}
							</p>
						))}
					</div>
			...
			<Show condition={typeof proyecto?.pathname !== 'undefined' && typeof proyecto?.imgAfter !== 'undefined'}>
				<h2 className='text-center  text-2xl md:text-3xl lg:text-5xl text-garden-option1 font-garden_bold z-10 drop-shadow-2xl shadow-garden-option1 pb-10'>
					Después
				</h2>
