    ...
    <>
      ...
      <Container className='flex flex-col-reverse lg:flex lg:flex-row py-10 gap-10 mt-10  '>
        <div className='flex flex-col gap-x-2 sm:gap-x-7 w-full lg:w-3/12 p-5 lg:px-3'>
          ...
          {serviciosLat.map((item, i) => (
            <div key={i} className='border-b-2 border-b-gray-200 py-4 lg:py-5'>
              <p
                ...
                className='text-gray-600 text-base lg:text-xl font-semibold hover:text-primary-300 ease-in-out duration-300 cursor-pointer'
              >
                {item.text}
              </p>
            </div>
          ...
          <p className='text-garden-option1 text-2xl md:text-3xl font-garden_medium py-5'>
            Productos similares
          </p>
        ...
        <div className='w-full lg:w-9/12 '>
          {url?.content.map((obj, i) => (
            <article className='' key={i}>
              ...
              <div className='text-gray-600 font-garden_regular text-base lg:text-lg font-light py-7 text-justify'>
