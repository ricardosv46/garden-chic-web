    ...
    <div className="py-10 md:py-16 bg-gray-50 " >
      <div className="container mx-auto px-6 md:px-12 xl:px-32 ">
        <div className="mb-10 text-center">
          ...
          {data.subtittle.split('//').map((obj, k) => <p key={k} className="text-garden-option3 lg:w-8/12 lg:mx-auto font-garden_regular text-base md:text-xl ">{obj || ''}</p>)}
        </div>
            ...
            <div className="space-y-4 text-center" key={i}>
              <div className="flex flex-col gap-2">
                <h2 className="lg:text-7xl md:text-4xl text-3xl text-garden-option1">
                  {inView ? <Contador className="font-garden_bold text-[32px]" duration={obj.duration || 1000} num={obj.count || '20'} /> : '0'}
                </h2>
