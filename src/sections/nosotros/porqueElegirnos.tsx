...
const PorqueElegirnos = () => {
	return (
		<Container bgColor='bg-gray-100' className='pt-10 pb-5'>
			...
			<div className='grid grid-cols-1 md:grid-cols-[50%,50%] bg-white '>
				<div className='order-2 md:order-1 py-3 px-6 text-xl lg:text-2xl h-full p-10 md:px-12 md:py-10 mb-4 md:mb-0 font-light'>
					<h2 className='font-bold leading-none text-xl md:text-2xl lg:text-4xl text-garden-option1'>¿Por qué elegirnos?</h2>
					<p className='text-xs md:text-base lg:text-xl font-extralight mt-8 text-justify  font-garden_regular text-garden-option3'>
						Trabajamos con un equipo multidisciplinario que ha participado en los principales proyectos de paisajismo en el país, tales
						como <span className='font-bold'>Los Juegos Panamericanos</span>, Edificios con certificación LEED, además somos proveedor
						oficial de
						...
						<span className='font-bold'> Perú Green Building Council</span> que tiene como objetivo principal el promover la reducción de
						las emisiones de carbono implementando Edificios Sostenibles.
					</p>
				</div>
				<div className='order-1 md:order-2 p-10 '>
					<div
						className={`w-full bg-top bg-no-repeat bg-cover h-[250px] md:h-[450px] `}
						style={{ backgroundImage: `url('/imgs/nosotros/header/02_POR_ELEGIRNOS.jpg')` }}
					/>
				</div>
			</div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-[50%,50%] p-6 lg:p-10 gap-4 md:gap-7'>
          ...
          <div className='order-2 md:order-1 text-xl font-light text-garden-option1 md:p-2 '>
